        ...
        return (
            <div className='bg-poke-red w-[400px] h-[600px] flex flex-col  rounded-2xl' >
                ...
                <div className='  mx-auto bg-poke-white-img p-8 rounded relative my-3'>
                    ...
                    <div className='bg-poke-blue w-64 h-64 '>
                ...
                <div className='flex h-44'>
                    <div className='w-12 h-12 rounded-full bg-poke-black-img border-solid border-2 border-poke-new-black-img my-2 mx-6' ></div>
