...
function Pokeinfo() {
    ...
    if(pokemon.length===0){
        ...
        return (
            <div className='bg-poke-red bg-gradient-to-t from-poke-new-red-img w-[400px] h-[504px] mt-14 rounded-2xl px-10 flex flex-col justify-evenly rounded-tl-none relative'>
                ...
                <div className='bg-poke-black-img p-2 rounded-lg border-solid border-2 border-poke-new-black-img flex flex-col items-center'>
                    <p className='mb-2'>{pokemon.name}</p>
                    <p className='mb-2'>Type {pokemon.types.map(type =>(
                            `${type.type.name}`
                    ))}</p>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative flex flex-col items-end'>
                        <div className='flex'>
                            <div className='w-12 h-3 rounded bg-poke-black-img border-solid border-2 border-poke-new-black-img mr-4' ></div>
                            <div className='w-12 h-3 rounded bg-poke-black-img border-solid border-2 border-poke-new-black-img ' ></div>
                        </div>
                ...
                <div className='flex justify-between items-center mb-6'>
                    <div className='bg-poke-black-img p-2 h-[50px] h rounded-lg border-solid border-2 border-poke-new-black-img flex items-center justify-center'>
                        <p>{specie.genera[7].genus}</p>
                    </div>
                    <div className='bg-poke-black-img p-1 rounded-lg border-solid border-2 border-poke-new-black-img flex items-center'>
